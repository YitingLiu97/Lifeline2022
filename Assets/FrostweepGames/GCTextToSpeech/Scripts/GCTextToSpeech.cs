...
namespace FrostweepGames.Plugins.GoogleCloud.TextToSpeech
{
    ...
    public class GCTextToSpeech : MonoBehaviour
    {
        ...
        public long Synthesize(string content, VoiceConfig voiceConfig, bool ssml = false, double pitch = 1.0, double speakingRate = 1.0, double sampleRateHertz = Constants.DEFAULT_SAMPLE_RATE, string[] effectsProfileId = null)
        {
