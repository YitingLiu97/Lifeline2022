...
namespace FrostweepGames.Plugins.GoogleCloud.SpeechRecognition.Examples
{
    public class GCSR_Example1 : MonoBehaviour
    {
        ...
        private void Start()
        {
            // when you turn on, it will start recognizing? 
            // when you say "Hello Bina, Bye Bina" - it will end. 
            // save the text afterwards 
            ...
            _startRecordButton = GameObject.Find("Canvas").transform.Find("Button_StartRecord").GetComponent<Button>();
            _stopRecordButton = GameObject.Find("Canvas").transform.Find("Button_StopRecord").GetComponent<Button>();
            _getOperationButton = GameObject.Find("Canvas").transform.Find("Button_GetOperation").GetComponent<Button>();
            _getListOperationsButton = GameObject.Find("Canvas").transform.Find("Button_GetListOperations").GetComponent<Button>();
            _detectThresholdButton = GameObject.Find("Canvas").transform.Find("Button_DetectThreshold").GetComponent<Button>();
            _cancelAllRequestsButton = GameObject.Find("Canvas").transform.Find("Button_CancelAllRequests").GetComponent<Button>();
            _recognizeButton = GameObject.Find("Canvas").transform.Find("Button_Recognize").GetComponent<Button>();
            _refreshMicrophonesButton = GameObject.Find("Canvas").transform.Find("Button_RefreshMics").GetComponent<Button>();

            _speechRecognitionState = GameObject.Find("Canvas").transform.Find("Image_RecordState").GetComponent<Image>();

            _resultText = GameObject.Find("Canvas").transform.Find("Panel_ContentResult/Text_Result").GetComponent<Text>();

            _voiceDetectionToggle = GameObject.Find("Canvas").transform.Find("Toggle_DetectVoice").GetComponent<Toggle>();
            _recognizeDirectlyToggle = GameObject.Find("Canvas").transform.Find("Toggle_RecognizeDirectly").GetComponent<Toggle>();
            _longRunningRecognizeToggle = GameObject.Find("Canvas").transform.Find("Toggle_LongRunningRecognize").GetComponent<Toggle>();

            _languageDropdown = GameObject.Find("Canvas").transform.Find("Dropdown_Language").GetComponent<Dropdown>();
            _microphoneDevicesDropdown = GameObject.Find("Canvas").transform.Find("Dropdown_MicrophoneDevices").GetComponent<Dropdown>();

            _contextPhrasesInputField = GameObject.Find("Canvas").transform.Find("InputField_SpeechContext").GetComponent<InputField>();
            _operationIdInputField = GameObject.Find("Canvas").transform.Find("InputField_Operation").GetComponent<InputField>();

            _voiceLevelImage = GameObject.Find("Canvas").transform.Find("Panel_VoiceLevel/Image_Level").GetComponent<Image>();
